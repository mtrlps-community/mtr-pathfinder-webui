...
main(station1=station1, station2=station2, LINK=LINK, LOCAL_FILE_PATH=LOCAL_FILE_PATH, DEP_PATH=DEP_PATH, BASE_PATH=BASE_PATH, PNG_PATH=PNG_PATH, MAX_WILD_BLOCKS=MAX_WILD_BLOCKS, TRANSFER_ADDITION=TRANSFER_ADDITION, WILD_ADDITION=WILD_ADDITION, STATION_TABLE=STATION_TABLE, ORIGINAL_IGNORED_LINES=ORIGINAL_IGNORED_LINES, UPDATE_DATA=UPDATE_DATA, GEN_DEPARTURE=GEN_DEPARTURE, IGNORED_LINES=IGNORED_LINES, ONLY_ROUTES=ONLY_ROUTES, AVOID_STATIONS=AVOID_STATIONS, CALCULATE_HIGH_SPEED=CALCULATE_HIGH_SPEED, CALCULATE_BOAT=CALCULATE_BOAT, CALCULATE_WALKING_WILD=CALCULATE_WALKING_WILD, ONLY_LRT=ONLY_LRT, DETAIL=DETAIL, MAX_HOUR=MAX_HOUR, show=True, departure_time=DEP_TIME)
